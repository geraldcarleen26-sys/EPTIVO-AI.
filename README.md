...
It helps users pick a niche + goal + effort, generates ranked content ideas, and learns preferences from likes/dislikes. It also includes a Live chat experience, a simple profile (name/username/photo), and a saved ideas list.
